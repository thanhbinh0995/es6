...
function calculateAge() {
  ...
  if (date) {
    ...
    var birthday = (0, _moment2.default)(date, "YYYY/MM/DD");
    var res = today.year() - birthday.year();
    var checkMonth = today.month() - birthday.month();
    var checkDate = today.date() - birthday.date();
    if (checkMonth < 0 || checkMonth === 0 && checkDate < 0) res = res - 1;else if (checkMonth > 0 || checkMonth === 0 && checkDate > 0) res = res + 1;
